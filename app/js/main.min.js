                ...
                <div class="employee__info">
                  ...
                  <div class="employee__info-box">
                    <ul class="employee__info-icons">
                      ...
                      ${e.new?'<li class="employee__info-icons-item employee__info-icons-item-new">New!</li>':""}
  ${e.featured?'<li class="employee__info-icons-item employee__info-icons-item-featured">Featured</li>':""}
                      
                    </ul>
                    <p class="employee__position">${e.position}</p>
